...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { arrival: @stop.arrival, departure: @stop.departure, port_id: @stop.port_id, voyage_id: @stop.voyage_id }
    end
  ...
  test "should update stop" do
    patch :update, id: @stop, stop: { arrival: @stop.arrival, departure: @stop.departure, port_id: @stop.port_id, voyage_id: @stop.voyage_id }
    assert_redirected_to stop_path(assigns(:stop))
  end
