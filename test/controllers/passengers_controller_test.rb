...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { birthdate: @passenger.birthdate, birthplace: @passenger.birthplace, deathdate: @passenger.deathdate, deathplace: @passenger.deathplace, name: @passenger.name, notability: @passenger.notability }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { birthdate: @passenger.birthdate, birthplace: @passenger.birthplace, deathdate: @passenger.deathdate, deathplace: @passenger.deathplace, name: @passenger.name, notability: @passenger.notability }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
